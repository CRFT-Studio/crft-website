...
An accordion is a [user interface](/glossary/user-interface) element consisting of vertically stacked headers that can be clicked to reveal or hide associated content panels. Like its musical namesake, it expands and contracts to show or conceal information, making it an efficient way to present content in a limited space.
...
- Providing clear [visual hierarchy](/glossary/visual-hierarchy)
...
- Consider [lazy loading](/glossary/lazy-loading) for content-heavy panels
