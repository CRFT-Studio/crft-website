...
Key frames originated in traditional animation, where animators would draw important frames to define major movements, while assistant animators would create the in-between frames (tweens). In web design, this concept has been adapted through [CSS](/glossary/css) animations (@keyframes) and [JavaScript](/glossary/javascript) [libraries](/glossary/library), making it possible to create sophisticated animations for websites and web applications.
...
- Hover effects
- [Micro-interactions](/glossary/micro-interactions)
...
- Ensure animations enhance rather than hinder [user experience](/glossary/user-experience)
