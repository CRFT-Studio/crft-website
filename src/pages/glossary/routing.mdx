...
- Full page reloads occur with each [navigation](/glossary/navigation)
- Better for initial [SEO](/glossary/seo) but slower [user experience](/glossary/user-experience)

### Client-Side Routing
- Modern approach used in [Single Page Applications](/glossary/single-page-application) (SPAs)
...
- Custom 404 pages
- Redirects
- [API](/glossary/api) routes
- [SSR](/glossary/server-side-rendering) and static output options
...
- Consider [code splitting](/glossary/code-splitting)
- Use preloading for critical routes

### Security
- Validate [URL parameters](/glossary/query-strings)
