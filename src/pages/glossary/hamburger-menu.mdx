...
A hamburger menu is a button commonly found in websites and applications that consists of three horizontal lines stacked on top of each other, resembling a hamburger. When clicked or tapped, it reveals a hidden [navigation](/glossary/navigation) menu containing links and other menu items.
...
- Ideal for [responsive design](/glossary/responsive-design) and [mobile-first](/glossary/mobile-first) approaches
...
- Ensure keyboard [accessibility](/glossary/accessibility)
