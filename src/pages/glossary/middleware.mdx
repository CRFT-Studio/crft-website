...
Reduces the size of response data before sending it to clients, improving performance and reducing [bandwidth](/glossary/bandwidth) usage.
...
Various [frameworks](/glossary/framework) and platforms offer middleware capabilities:
