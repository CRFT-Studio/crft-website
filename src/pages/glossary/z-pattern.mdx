...
2. Top-right: Often features important [navigation](/glossary/navigation) elements or calls-to-action
3. Bottom-left: Secondary content or supporting information
4. Bottom-right: Final [call-to-action](/glossary/call-to-action) or conclusion

## When to Use the Z-Pattern

The Z-Pattern is particularly effective for:

- Simple [landing pages](/glossary/landing-page)
...
### Enhanced [Conversion Rates](/glossary/conversion-rate)
...
### Better [Visual Hierarchy](/glossary/visual-hierarchy)
...
### Visual Elements
Use design elements like contrast, size, and [white space](/glossary/white-space) to reinforce the Z-Pattern and guide users' attention along the intended path.
