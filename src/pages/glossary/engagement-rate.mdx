...
Engagement rate is a [key performance indicator (KPI)](/glossary/key-performance-indicator) that measures how actively involved your audience is with your digital content. It quantifies the level of interaction, such as likes, comments, shares, and clicks, relative to your total audience or reach.
...
- Websites: Page views, [time on site](/glossary/time-on-site), [bounce rate](/glossary/bounce-rate), and scroll depth
...
- [A/B testing](/glossary/ab-testing) different content types and formats
