...
- Maintain adequate quiet zones ([white space](/glossary/white-space)) around the code
- Ensure sufficient size for reliable scanning
- Test contrast and readability
- Consider incorporating brand colors (while maintaining contrast)
- Add a clear [call-to-action](/glossary/call-to-action) near the code
...
- Monitor scanning [analytics](/glossary/analytics) when possible
