...
### Hierarchy
Use varying amounts of white space to establish [visual hierarchy](/glossary/visual-hierarchy). More important elements should have more breathing room around them to draw attention.
...
Many clients and stakeholders mistakenly view white space as wasted space that could be filled with more content. However, effective use of white space is not about emptiness – it's about creating purposeful breathing room that enhances the [user experience](/glossary/user-experience) and communication of your message.
