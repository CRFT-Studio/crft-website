...
- Higher frame rates for [dynamic content](/glossary/dynamic-content)
...
### [Optimization](/glossary/optimization) Considerations
...
- Complex transitions
- Parallax effects
- Interactive [user interface](/glossary/user-interface) elements
- Video playback
- Canvas animations
...
- Provide better overall [user experience](/glossary/user-experience)
