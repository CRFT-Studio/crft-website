...
- More readable than [JSON](/glossary/json) or [XML](/glossary/xml)
...
- [Static site](/glossary/static-content) generators
- [CI/CD](/glossary/ci-cd) pipeline configurations

## YAML in Astro

Astro, the web [framework](/glossary/framework) we use to build websites, specifically uses YAML in two primary ways:
...
- Validate YAML syntax before [deployment](/glossary/deploy)
