...
A zero-state is the empty or default condition of a [user interface](/glossary/user-interface) when there is no user-generated content, data, or activity to display. This state occurs when users first interact with an application or when they've cleared all content from a specific feature.

## Importance of Zero-State Design

Zero-state design plays a crucial role in [user experience](/glossary/user-experience) as it represents a critical first impression and onboarding opportunity. Well-designed zero-states can:
...
- Maintain [design system](/glossary/design-system) guidelines
