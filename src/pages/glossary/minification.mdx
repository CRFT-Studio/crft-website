...
Minification is a crucial [optimization](/glossary/optimization) technique in web development that involves removing unnecessary characters from source code without changing its functionality. This includes eliminating [white space](/glossary/white-space), new lines, comments, and shortening variable names to reduce file size and improve website performance.
...
- Better [user experience](/glossary/user-experience)
...
### File Types Affected
- [JavaScript](/glossary/javascript) (.js)
- [CSS](/glossary/css) (.css)
- HTML (.html)
- SVG files
- [JSON](/glossary/json) data

## Astro's Built-in Minification

One of the advantages of using [Astro](https://astro.build/), our [web framework](/glossary/framework) of choice at CRFT Studio, is its built-in minification capabilities. During the [build process](/glossary/build-process), Astro automatically:
