...
One of the advantages of using [Astro](https://astro/), our [web framework](/glossary/framework) of choice at CRFT Studio, is its built-in minification capabilities. During the build process, Astro automatically:
