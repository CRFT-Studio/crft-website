...
The Document Object Model (DOM) is a cross-platform, language-independent interface that treats HTML, XHTML, or [XML](/glossary/xml) documents as a tree structure where each node represents a part of the document. It defines the logical structure of documents and the way they can be accessed and manipulated by programming languages, particularly [JavaScript](/glossary/javascript) in web browsers.
...
- [Caching](/glossary/cache) DOM references
...
- [Dynamic content](/glossary/dynamic-content) updates
- Interactive [user interfaces](/glossary/user-interface)
- Form validation
- Event handling
- AJAX operations
- Single-page applications ([SPAs](/glossary/single-page-application))
