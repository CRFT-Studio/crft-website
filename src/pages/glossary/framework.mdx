...
### [Frontend](/glossary/frontend) Frameworks
Frontend frameworks like React, Vue.js, and Angular help developers build [user interfaces](/glossary/user-interface) and handle client-side operations. They provide ready-to-use components, state management solutions, and tools for creating responsive, interactive web applications.

### [Backend](/glossary/backend) Frameworks
Backend frameworks such as Django, Ruby on Rails, and Express.js facilitate server-side development. They handle database operations, server logic, and [API](/glossary/api) creation, often following the MVC (Model-View-Controller) pattern.
...
- Modern Developer Experience: Hot module reloading, automatic asset [optimization](/glossary/optimization)

## Framework Philosophy

### [Progressive Enhancement](/glossary/progressive-enhancement)

We believe in starting with the basics - clean HTML and [CSS](/glossary/css) - and progressively enhancing the experience where JavaScript adds genuine value. This approach ensures our sites remain accessible and functional for all users, regardless of their device or connection speed.
...
- Maintain consistent [design systems](/glossary/design-system) 
