...
### Locate Drop-Off
[Analytics](/glossary/analytics) can show exactly where users abandon the journey.

### Prioritize [UX](/glossary/user-experience) Work
Teams focus improvements on the stages with the biggest leakage or revenue impact.

### Align Marketing and Product
Shared funnel metrics connect campaigns, [landing pages](/glossary/landing-page), and product experience.
...
5. [A/B test](/glossary/ab-testing) changes and measure lift by stage and overall
