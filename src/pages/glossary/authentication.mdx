...
### OAuth 2.0
The industry-standard protocol for authorization, OAuth 2.0 enables third-party applications to obtain limited access to user accounts on an [HTTP](/glossary/http) service. It's commonly used for social authentication implementations.

### [JSON](/glossary/json) Web Tokens (JWT)
...
- Use [HTTPS](/glossary/ssl-certificate) for all authentication requests
- Implement [rate limiting](/glossary/rate-limit) to prevent brute force attacks
