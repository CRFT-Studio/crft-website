...
At CRFT Studio, we leverage PostHog's powerful [analytics](/glossary/analytics) platform to implement and track NPS for our clients. Using PostHog's survey feature and custom dashboards, we:
...
- Combine NPS data with other PostHog metrics like feature usage and [user flows](/glossary/user-flows)
- Create comprehensive dashboards that show the relationship between NPS and other [KPIs](/glossary/key-performance-indicator)
