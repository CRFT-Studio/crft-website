...
- `button` for actions
- `a` for [navigation](/glossary/navigation) links
...
Semantic HTML is one of the highest-ROI foundations in [front-end](/glossary/frontend) work: it improves accessibility, SEO, and code clarity with relatively little extra effort.
