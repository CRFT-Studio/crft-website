...
- [JavaScript](/glossary/javascript) form validation
...
- Trimming [whitespace](/glossary/white-space)
...
- [Cross-Site Scripting](/glossary/XSS) (XSS) prevention
- [SQL](/glossary/sql) injection protection
...
- Use established validation [libraries](/glossary/library) and [frameworks](/glossary/framework)
