...
At CRFT Studio, we use [Astro](https://astro.build) as our primary framework for building marketing websites. Astro's philosophy of "Zero JavaScript by default" aligns perfectly with modern web development best practices. It allows us to be selective about which components need to be dynamic, ensuring optimal site performance.
