...
A canonical URL is an HTML element that specifies the preferred or main version of a webpage when similar or identical content exists at multiple [URLs](/glossary/url). It helps search engines understand which version of a page should be indexed and displayed in search results, preventing duplicate content issues.

## Why Canonical URLs Matter

Canonical URLs play a crucial role in website [optimization](/glossary/optimization) and [SEO](/glossary/seo) strategy. They help maintain clean search engine results by consolidating ranking signals across similar pages and ensuring that the correct version of a page receives the maximum search visibility.
...
4. Pages accessible through multiple [URL parameters](/glossary/query-strings)
...
### HTTP Header
For non-HTML documents like PDFs, canonical URLs can be specified through [HTTP headers](/glossary/http):
```
