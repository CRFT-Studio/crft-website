...
3. Front ends request content via API (REST or GraphQL)
4. Each channel renders content in its own UI layer
...
3. Use CDN caching for API responses where appropriate
