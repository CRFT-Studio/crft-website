...
## Modern Solutions and [CDNs](/glossary/cdn)
...
- DDoS protection
- Automatic [optimization](/glossary/optimization) of assets
...
- [Minify](/glossary/minification) [CSS](/glossary/css), [JavaScript](/glossary/javascript), and HTML
