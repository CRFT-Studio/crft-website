...
### Tools and Methods
Most [analytics](/glossary/analytics) platforms, including Google Analytics, automatically track return visitors. They use various methods to identify returning users:
- Browser [cookies](/glossary/cookie)
- User accounts
...
- Create intuitive [navigation](/glossary/navigation)
