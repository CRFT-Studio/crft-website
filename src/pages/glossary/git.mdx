...
### Commits
A commit represents a snapshot of your project at a specific point in time. Each commit includes a unique identifier, a message describing the changes, and [metadata](/glossary/metadata) about who made the changes and when.
