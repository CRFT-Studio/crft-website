...
- Clicking [navigation](/glossary/navigation) elements
- Filling out forms
- Making selections
...
### Enhanced Conversion [Optimization](/glossary/optimization)
Well-designed user flows can significantly impact [conversion rates](/glossary/conversion-rate) by:
...
- User interviews
- [Analytics](/glossary/analytics) data
- Behavior tracking
