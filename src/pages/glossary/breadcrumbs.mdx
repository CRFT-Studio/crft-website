...
A breadcrumb navigation system is a [user interface](/glossary/user-interface) element that provides users with a visual representation of their current location within a website's hierarchical structure, typically displayed as a horizontal line of text links separated by symbols (often forward slashes or arrows).
...
### Improved [Navigation](/glossary/navigation)
...
### SEO Advantages
Breadcrumbs can improve [search engine optimization](/glossary/seo) by:
...
- Use [semantic HTML](/glossary/semantic-html) markup (nav element with aria-label)
...
- Poor mobile [optimization](/glossary/optimization)
