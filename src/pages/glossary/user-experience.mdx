...
### Usability
The ease with which users can accomplish their goals when using a product. This includes factors like [navigation](/glossary/navigation) efficiency, task completion rates, and learning curve.
...
### [Information Architecture](/glossary/information-architecture)
...
### Design
Creating [wireframes](/glossary/wireframe), prototypes, and [user flows](/glossary/user-flows) that address identified needs and problems.
