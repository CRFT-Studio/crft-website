...
- `Access-Control-Allow-Methods`: Lists permitted [HTTP methods](/glossary/http)
...
- Implement proper [authentication](/glossary/authentication) and authorization
- Validate and sanitize all cross-origin requests
- Use [HTTPS](/glossary/ssl-certificate) for all cross-origin communications
