...
A micro-interaction is a contained product moment that revolves around a single use case—an instance of user interaction that accomplishes a small, specific task while providing visual feedback. These subtle design elements serve both functional and delightful purposes in digital interfaces, helping users understand the results of their actions while adding personality to the [user experience](/glossary/user-experience).
...
### [Navigation](/glossary/navigation) Elements
- [Hamburger menu](/glossary/hamburger-menu) animations
...
Optimize animations and transitions to ensure they don't impact [page load times](/glossary/page-load-time) or device performance.
