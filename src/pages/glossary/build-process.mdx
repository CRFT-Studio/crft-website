...
### Compilation
During building, source code written in languages like TypeScript, SCSS, or JSX gets compiled into standard formats that browsers can understand ([JavaScript](/glossary/javascript) and [CSS](/glossary/css)). This step ensures compatibility across different platforms and browsers.

### [Bundling](/glossary/bundling)
The build process combines multiple code files into a smaller number of optimized bundles. This reduces [HTTP](/glossary/http) requests and improves loading performance. Modern bundlers like Webpack, Rollup, or Vite handle [dependencies](/glossary/dependencies), create efficient chunks, and manage asset loading.
...
- [Code splitting](/glossary/code-splitting) creates smaller, more manageable chunks
...
- Next.js and Nuxt.js: [Framework](/glossary/framework)-specific builders
