...
- Node.js for [JavaScript](/glossary/javascript)
...
### Performance
- Runtime performance affects [user experience](/glossary/user-experience)
...
- [Input validation](/glossary/input-validation) prevents malicious code execution
