...
- Multiple synchronous [API](/glossary/api) calls

## Optimizing TBT with Astro

At CRFT Studio, we leverage [Astro](https://astro.build) as our preferred [framework](/glossary/framework) to optimize Total Blocking Time. Astro's unique "zero JavaScript by default" approach provides several advantages:
