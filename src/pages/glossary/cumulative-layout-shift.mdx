...
- **Impact fraction**: how much of the [viewport](/glossary/viewport) is affected
...
### Dynamically Injected [UI](/glossary/user-interface)
Banners, [cookie](/glossary/cookie) notices, and late-loading modules can shove content around after the user starts reading.
...
- Google [Lighthouse](/glossary/lighthouse)
